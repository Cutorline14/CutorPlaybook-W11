...
# Duplicate Ultimate Performance power scheme, customize it and make it the Cutor power scheme
...
powercfg /changename scheme_current "Extreme Performance" "Improve FPS and Input-Lag on Gaming by Cutorline14."
...
& "$windir\CutorModules\Scripts\toggleDev.cmd" -Disable '@("ACPI Processor Aggregator", "Microsoft Windows Management Interface for ACPI")' | Out-Null
