.\CutorModules\initPowerShell.ps1
$windir = [Environment]::GetFolderPath('Windows')

Write-Title "Creating Desktop & Start Menu shortcuts..."

# Default user
$defaultShortcut = "$(Get-UserPath)\Cutor.lnk"
New-Shortcut -Source "$windir\CutorDesktop" -Destination $defaultShortcut -Icon "$windir\CutorModules\Other\cutor-folder.ico,0"
