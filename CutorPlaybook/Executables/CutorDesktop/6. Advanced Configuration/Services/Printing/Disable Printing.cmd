...
if /i not "%~1"=="/silent" if /i not "%~1"=="/justcontext" call "%windir%\CutorModules\Scripts\serviceWarning.cmd" %*
...
call "%windir%\CutorModules\Scripts\setSvc.cmd" Spooler 4
call "%windir%\CutorModules\Scripts\setSvc.cmd" PrintWorkFlowUserSvc 4

call "%windir%\CutorModules\Scripts\settingsPages.cmd" /hide printers
