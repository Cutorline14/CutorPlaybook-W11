...
reg add "HKLM\SOFTWARE\Cutor\Services\%settingName%" /v state /t REG_SZ /d "0" /f > nul
goto finish

:enable
bcdedit /set {default} bootmenupolicy standard > nul 2>&1
reg add "HKLM\SOFTWARE\Cutor\Services\%settingName%" /v state /t REG_SZ /d "1" /f > nul
goto finish
