...
reg add "HKLM\SOFTWARE\Cutor\Services\%settingName%" /v state /t REG_DWORD /d "0" /f > nul
goto finish

:enable
bcdedit /set {globalsettings} advancedoptions true > nul
reg add "HKLM\SOFTWARE\Cutor\Services\%settingName%" /v state /t REG_DWORD /d "1" /f > nul
goto finish
