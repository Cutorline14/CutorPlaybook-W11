...
reg add "HKLM\SOFTWARE\Cutor\Services%settingNameFeature%" /v days /t REG_DWORD /d 0 /f >nul
...
reg add "HKLM\SOFTWARE\Cutor\Services%settingNameQuality%" /v days /t REG_DWORD /d 0 /f >nul
