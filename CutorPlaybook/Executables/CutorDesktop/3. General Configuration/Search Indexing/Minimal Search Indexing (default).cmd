...
set "stateValue=1"
set "scriptPath=%~f0"
set indexConfPath="%windir%\CutorModules\Scripts\indexConf.cmd"
...
if not exist "%indexConfPath%" (
    echo The 'indexConf.cmd' script wasn't found in CutorModules.
    pause
    exit /b 1
)
...
%indexConf% /include "%windir%\CutorDesktop"
