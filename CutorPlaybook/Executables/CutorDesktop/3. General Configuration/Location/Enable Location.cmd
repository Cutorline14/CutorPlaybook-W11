...
call "%windir%\CutorModules\Scripts\settingsPages.cmd" /unhide privacy-location
...
if %errorlevel%==1 (
    ...
    call "%windir%\CutorModules\Scripts\settingsPages.cmd" /unhide findmydevice /silent
)
if %errorlevel%==2 (
