...
:: Main settings
call "%windir%\CutorModules\Scripts\settingsPages.cmd" /unhide search-permissions /silent
(
...
if %errorlevel%==1 call "%windir%\CutorDesktop\3. General Configuration\Search Indexing\Enable Search Indexing.cmd" /silent & set ____restart=true
exit /b