...
if %errorlevel%==1 (
	start "Enabling Hibernation" "%windir%\CutorDesktop\3. General Configuration\Hibernation\Enable Hibernation.cmd"
) else (
	start "Disabling Hibernation" "%windir%\CutorDesktop\3. General Configuration\Hibernation\Disable Hibernation (default).cmd"
)
