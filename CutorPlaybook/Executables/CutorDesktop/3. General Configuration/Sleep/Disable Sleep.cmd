...
if %errorlevel%==1 (
	call "%windir%\CutorDesktop\3. General Configuration\Hibernation\Disable Hibernation (default).cmd" /silent
) else (
	call "%windir%\CutorDesktop\3. General Configuration\Hibernation\Enable Hibernation.cmd" /silent
)
